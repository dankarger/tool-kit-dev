      ...
      <ul className=" flex flex-col-reverse">
        {sessions.map((session) => (
          <li
            key={session.id}
            value={session.id}
            className="lg:dark:hover: lg:dark:hover: flex  flex-col     justify-start  rounded-md  border-gray-300   align-middle  hover:cursor-pointer lg:dark:hover:border-gray-700 lg:dark:hover:bg-gray-800 lg:dark:hover:text-white lg:dark:hover:shadow-sm lg:dark:hover:shadow-xl lg:dark:hover:shadow-gray-900"
            onClick={onClick}
